      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="animate-reveal">
            <h2 className="text-[42px] md:text-[64px] font-black tracking-tight-custom mb-12 leading-[1.1] text-black">
              Legacy <br />
              <span className="font-serif font-light italic opacity-30">Stitched in Time.</span>
            </h2>
            
            <p className="text-base md:text-lg text-black font-semibold leading-relaxed mb-10 font-inter max-w-lg">
            ...
            <div className="space-y-8 text-sm md:text-base font-light text-[#666666] leading-relaxed mb-16 max-w-lg font-inter">
              <p>
            ...
            <button 
              onClick={onKnowMore}
              className="group flex items-center gap-6 px-8 py-3 bg-black text-white rounded-full text-[12px] font-semibold uppercase tracking-widest-custom hover:bg-neutral-800 transition-all"
            >
          ...
          <div className="relative animate-reveal" style={{ animationDelay: '0.2s' }}>
            <div className="aspect-[4/5] rounded-[32px] overflow-hidden border border-black/5 bg-neutral-100">
              <img 
