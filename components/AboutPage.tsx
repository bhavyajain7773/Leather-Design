...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white text-black transition-colors duration-500 pt-12">
      
      {/* SECTION 1: IDENTITY */}
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 px-6 max-w-7xl mx-auto">
        <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-neutral-100 border border-black/5 rounded-full mb-8 md:mb-12 animate-reveal">
          <Star size={12} className="text-black" />
          <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest-custom text-black">Identity Statement</span>
        </div>
        
        <h1 className="text-[36px] sm:text-[42px] md:text-[64px] font-black leading-[1.1] tracking-tight-custom mb-10 md:mb-16 animate-reveal text-black">
          The Soul <br />
          <span className="opacity-30 font-serif italic font-light">of Jodhpur.</span>
        </h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start animate-reveal" style={{ animationDelay: '0.2s' }}>
          <div className="lg:col-span-8">
            <p className="text-xl md:text-3xl font-semibold leading-tight mb-8 md:mb-12 text-black">
            ...
            <div className="space-y-6 md:space-y-8 text-base md:text-lg font-light text-[#666666] leading-relaxed max-w-2xl">
              <p>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6 w-full">
            <div className="p-8 md:p-10 bg-neutral-50 rounded-[24px] md:rounded-[32px] border border-black/5">
              <h4 className="text-[9px] md:text-[10px] font-black uppercase tracking-widest mb-6 opacity-40">Export Standards</h4>
              <ul className="space-y-4 text-[10px] md:text-[11px] font-semibold uppercase tracking-widest-custom">
      ...
      <section className="bg-black text-white py-16 md:py-20 px-6 rounded-[24px] md:rounded-[32px] mx-4 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 md:gap-6 mb-12 md:mb-20 opacity-30">
            <div className="h-px w-10 md:w-16 bg-white" />
            <span className="text-[10px] md:text-[11px] font-semibold uppercase tracking-widest-custom">The Heritage Narrative</span>
          </div>

          <div className="space-y-12 md:space-y-16">
            <h2 className="font-serif italic text-[24px] sm:text-[32px] md:text-[52px] leading-tight text-white/90">
              "Workmanship is our only true currency. We export the soul of Jodhpur, refined for the rigor of the global market."
            </h2>
            
            <div className="space-y-8 md:space-y-12 text-base md:text-lg font-light text-neutral-400 max-w-3xl leading-relaxed">
              <p>
      ...
      <section className="bg-white text-black py-16 md:py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[32px] sm:text-[42px] md:text-[64px] font-black mb-8 md:mb-12 tracking-tight-custom leading-[1.1]">Export Desk</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-16 md:mb-20 text-left">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest opacity-40">Direct Line</span>
              <p className="text-base md:text-lg font-semibold">+91 7793003465</p>
            </div>
            <div className="flex flex-col gap-2">
