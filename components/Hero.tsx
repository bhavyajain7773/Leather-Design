  ...
  return (
    <section className="relative pt-32 pb-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        <div className="inline-flex items-center space-x-2 px-4 py-2 bg-neutral-100 border border-black/5 rounded-full mb-8 animate-reveal" style={{ animationDelay: '0.1s' }}>
        ...
        <h1 className="text-[42px] md:text-[64px] font-black leading-[1.1] tracking-tight-custom mb-10 animate-reveal" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="max-w-2xl mb-12 animate-reveal" style={{ animationDelay: '0.3s' }}>
